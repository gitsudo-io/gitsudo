defmodule Gitsudo.Labels.Label do
  ...
  schema "labels" do
    ...
    has_many :collaborator_policies, Gitsudo.Policies.CollaboratorPolicy, on_replace: :delete
  ...
  def changeset(label, attrs) do
    ...
    |> cast_assoc(:collaborator_policies, with: &Gitsudo.Policies.CollaboratorPolicy.changeset/2)
