defmodule GitsudoWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :gitsudo_web
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :gitsudo_web
  end
