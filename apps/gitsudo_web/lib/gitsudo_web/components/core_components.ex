defmodule GitsudoWeb.CoreComponents do
  @moduledoc """
  ...
  """
  attr :class, :string, default: "pt-4"
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(GitsudoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(GitsudoWeb.Gettext, "errors", msg, opts)
    end
  end
